...
1. Party mode reads `.pap/_cfg/agent-manifest.csv`
...
Party mode uses agents from `.pap/[module]/agents/*.md` - these already include any customizations you applied during install.

**To customize agents for party mode:**

1. Create customization file: `.pap/_cfg/agents/bmm-pm.customize.yaml`
