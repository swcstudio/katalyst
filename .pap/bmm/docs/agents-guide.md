...
**Customization Directory:** `{project-root}/.pap/_cfg/agents/`
...
# {project-root}/.pap/_cfg/agents/{module}-{agent-name}.customize.yaml

# Example: .pap/_cfg/agents/bmm-pm.customize.yaml
```
