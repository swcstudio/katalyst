...
<critical>The workflow execution engine is governed by: {project-root}/.pap/core/tasks/workflow.xml</critical>
<critical>You MUST have already loaded and processed: {project-root}/.pap/bmm/workflows/document-project/workflow.yaml</critical>
...
<invoke-workflow path="{project-root}/.pap/bmm/workflows/workflow-status">
