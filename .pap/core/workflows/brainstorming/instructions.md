...
<workflow>
<critical>The workflow execution engine is governed by: {project_root}/.pap/core/tasks/workflow.xml</critical>
<critical>You MUST have already loaded and processed: {project_root}/.pap/core/workflows/brainstorming/workflow.yaml</critical>
...
<invoke-task halt="true">{project-root}/.pap/core/tasks/adv-elicit.xml</invoke-task>
