...
> Source: `src/examples/AdvancedIntegrationDemo.tsx`
...
- `../dev-tools/performance-profiler.js`
- `../native/adaptive-resource-manager.js`

## Exports

### `AdvancedIntegrationDemo`

<!-- TODO: Add detailed documentation for AdvancedIntegrationDemo -->
