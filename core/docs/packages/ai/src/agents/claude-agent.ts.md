...
> Source: `src/agents/claude-agent.ts`
...
<!-- TODO: Add detailed documentation for ClaudeConfig -->

### `ClaudeCodeConfig`

<!-- TODO: Add detailed documentation for ClaudeCodeConfig -->

### `ClaudeAgent`

<!-- TODO: Add detailed documentation for ClaudeAgent -->
