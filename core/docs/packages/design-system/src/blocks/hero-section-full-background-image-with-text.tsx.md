...
> Source: `src/blocks/hero-section-full-background-image-with-text.tsx`
...
<!-- TODO: Add detailed documentation for FullBackgroundImageWithText -->
...
<!-- TODO: Add detailed documentation for BlurImage -->
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col items-center justify-center p-10">
      ...
      <p className="relative z-10 mt-2 max-w-2xl text-center text-neutral-200 md:mt-6 md:text-xl">
        We&apos;re building a community of indie hackers to help each other succeed. Get in touch
        with us to join the community.
      </p>
