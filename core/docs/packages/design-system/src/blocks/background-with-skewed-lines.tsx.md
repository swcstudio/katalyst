...
> Source: `src/blocks/background-with-skewed-lines.tsx`
...
<!-- TODO: Add detailed documentation for BackgroundWithSkewedLines -->
  ...
  return (
    <div className="relative z-10">
      ...
      <p className="text-balance mx-auto mt-4 max-w-2xl text-center text-base text-neutral-800 dark:text-neutral-200">
        We are a team of developers who are passionate about creating web apps that make you feel
...
const Background = () => {
  return (
    ...
    >
      ...
      >
        <defs>
          <pattern id="skewed-lines" width="40" height="40" patternUnits="userSpaceOnUse">
            <path
