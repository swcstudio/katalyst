...
**Anti-pattern:** Adding `.pap/` to `.gitignore` breaks IDE tools, submodule management.
...
# Make personal customizations in .pap/
```
...
```bash
cd /path/to/your-project
# BMad available at ./.pap/, load agents normally
```
