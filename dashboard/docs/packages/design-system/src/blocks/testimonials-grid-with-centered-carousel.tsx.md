...
> Source: `src/blocks/testimonials-grid-with-centered-carousel.tsx`
...
<!-- TODO: Add detailed documentation for TestimonialsGridWithCenteredCarousel -->

### `TestimonialsGrid`

<!-- TODO: Add detailed documentation for TestimonialsGrid -->
...
<!-- TODO: Add detailed documentation for Quote -->

### `QuoteDescription`

<!-- TODO: Add detailed documentation for QuoteDescription -->

### `testimonials`

<!-- TODO: Add detailed documentation for testimonials -->

### `TestimonialsSlider`

<!-- TODO: Add detailed documentation for TestimonialsSlider -->
...
export const Quote = ({
  ...
  return (
    <h3 className={cn('text-xs font-semibold dark:text-white text-black py-2', className)}>
      {children}
    </h3>
  );
};
              ...
              {slicedTestimonials.map((item, index) => (
                ...
                >
                  <span className="relative">
                    <span className="text-neutral-50 font-bold">{item.name}</span>{' '}
                  </span>
                </button>
              ))}
            </div>
