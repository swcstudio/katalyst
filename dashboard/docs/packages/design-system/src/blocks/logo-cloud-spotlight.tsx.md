...
> Source: `src/blocks/logo-cloud-spotlight.tsx`
...
<!-- TODO: Add detailed documentation for SpotlightLogoCloud -->

### `AmbientColor`

<!-- TODO: Add detailed documentation for AmbientColor -->
  ...
  return (
    <div className="relative w-full overflow-hidden py-40">
      ...
      <div className="relative mx-auto grid w-full max-w-3xl grid-cols-4 gap-10">
        {logos.map((logo, idx) => (
          <div key={logo.src + idx + 'logo-spotlight'} className="flex items-center justify-center">
            <Image
              src={logo.src}
              alt={logo.name}
              width={100}
