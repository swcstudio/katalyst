...
> Source: `src/blocks/background-with-full-video.tsx`
...
<!-- TODO: Add detailed documentation for BackgroundWithFullVideo -->

### `ColourfulText`

<!-- TODO: Add detailed documentation for ColourfulText -->
...
const Background = () => {
  return (
    ...
    >
      ...
      >
        <source src="https://assets.aceternity.com/background-demo.mp4" type="video/mp4" />
      </video>
    </motion.div>
  );
};
