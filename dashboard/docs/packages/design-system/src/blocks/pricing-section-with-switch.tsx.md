...
> Source: `src/blocks/pricing-section-with-switch.tsx`
...
<!-- TODO: Add detailed documentation for PricingWithSwitch -->
  ...
  return (
    <div className="relative mx-auto flex max-w-7xl flex-col items-center justify-between py-10 md:py-20">
      <div className="relative">
        ...
        >
          Every AI offers a wide range of services. You can choose the one that suits your needs.
          Select from your favourite plan and get started instantly.
        </p>
      </div>
      <Pricing />
    </div>
          ...
          >
            <div className="">
              <h3
                id={tier.id}
                className={cn(
                  tier.featured ? 'text-white' : 'text-neutral-700 dark:text-neutral-400',
