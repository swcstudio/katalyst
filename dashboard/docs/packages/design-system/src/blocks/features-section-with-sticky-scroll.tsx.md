...
> Source: `src/blocks/features-section-with-sticky-scroll.tsx`
...
<!-- TODO: Add detailed documentation for FeaturesWithStickyScroll -->

### `StickyScroll`

<!-- TODO: Add detailed documentation for StickyScroll -->

### `ScrollContent`

<!-- TODO: Add detailed documentation for ScrollContent -->

### `ScrollContentMobile`

<!-- TODO: Add detailed documentation for ScrollContentMobile -->
...
export const ScrollContentMobile = ({
  ...
  return (
    ...
    >
      <motion.div key={item.title + index} className="mb-8 w-full self-start rounded-md">
        {item.content && item.content}
      </motion.div>
      <div className="w-full">
