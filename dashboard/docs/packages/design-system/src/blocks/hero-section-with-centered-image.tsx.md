...
> Source: `src/blocks/hero-section-with-centered-image.tsx`
...
<!-- TODO: Add detailed documentation for HeroWithCenteredImage -->

### `Badge`

<!-- TODO: Add detailed documentation for Badge -->
...
export function HeroWithCenteredImage() {
  return (
    <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col overflow-hidden pt-20 md:pt-40">
      ...
      >
        Space Rocket Tech is a team of passionate and experienced professionals who are dedicated to
        helping you achieve your content marketing goals.
      </motion.p>
      <motion.div
      ...
      >
        ...
        <Button variant="simple" href="#" className="group flex items-center space-x-2">
...
export const Button: React.FC<{
  ...
  [x: string]: any;
}> = ({ children, className, variant = 'primary', as: Tag = 'button' as any, ...props }) => {
  const variantClass =
    variant === 'simple'
