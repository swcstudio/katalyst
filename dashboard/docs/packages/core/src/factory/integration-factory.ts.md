...
> Source: `src/factory/integration-factory.ts`
...
- `../integrations/arco.ts`
- `../integrations/asset-manifest.ts`
- `../integrations/cosmos.ts`
- `../integrations/emp.ts`
- `../integrations/esmx.ts`
- `../integrations/fast-refresh.ts`
- `../integrations/inspector.ts`
- `../integrations/midscene.ts`
- `../integrations/multithreading.ts`
- `../integrations/ngrok.ts`
- `../integrations/nx.ts`
- `../integrations/pareto.ts`
- `../integrations/repack.ts`
- `../integrations/rspack.ts`
- `../integrations/rspeedy.ts`
- `../integrations/sails.ts`
- `../integrations/storybook.ts`
- `../integrations/stylex.ts`
- `../integrations/svgr.ts`
- `../integrations/tanstack.ts`
- `../integrations/tapable.ts`
- `../integrations/tauri.ts`
- `../integrations/typia.ts`
- `../integrations/umi.ts`
- `../integrations/virtual-modules.ts`
- `../integrations/webxr.ts`
- `../integrations/zephyr.ts`
- `../types/index.ts`
...
<!-- TODO: Add detailed documentation for IntegrationFactory -->
