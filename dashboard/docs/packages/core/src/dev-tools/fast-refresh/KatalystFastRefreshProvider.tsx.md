...
> Source: `src/dev-tools/fast-refresh/KatalystFastRefreshProvider.tsx`
...
- `./integrations/ngrok-fast-refresh`
- `./integrations/repack-fast-refresh`
- `./integrations/stylex-fast-refresh`
- `./integrations/tanstack-fast-refresh`

## Exports

### `FastRefreshConfig`

<!-- TODO: Add detailed documentation for FastRefreshConfig -->

### `FastRefreshContextValue`

<!-- TODO: Add detailed documentation for FastRefreshContextValue -->

### `KatalystFastRefreshProvider`

<!-- TODO: Add detailed documentation for KatalystFastRefreshProvider -->

### `useFastRefresh`

<!-- TODO: Add detailed documentation for useFastRefresh -->

### `FastRefreshError`

<!-- TODO: Add detailed documentation for FastRefreshError -->

### `FastRefreshStats`

<!-- TODO: Add detailed documentation for FastRefreshStats -->

### `RefreshUpdate`

<!-- TODO: Add detailed documentation for RefreshUpdate -->
