...
installed_path: "{project-root}/.pap/bmm/workflows/1-analysis/brainstorm-project"
template: false
...
core_brainstorming: "{project-root}/.pap/core/workflows/brainstorming/workflow.yaml"
