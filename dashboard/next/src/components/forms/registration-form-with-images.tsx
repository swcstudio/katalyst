    ...
    <div className="grid min-h-screen w-full grid-cols-1 md:grid-cols-2">
      ...
      <div className="relative z-20 hidden w-full items-center justify-center overflow-hidden border-l border-neutral-100 bg-white md:flex dark:border-neutral-800 dark:bg-neutral-900">
        <div className="mx-auto max-w-sm">
          ...
          >
            DevStudio is loved by thousands of people across the world, be part of the community and
            join us.
          </p>
        </div>

        <GridLineHorizontal className="left-1/2 top-4 -translate-x-1/2" offset="-10px" />
        <GridLineHorizontal
        ...
        <GridLineVertical className="left-auto right-10 top-1/2 -translate-y-1/2" offset="-10px" />
