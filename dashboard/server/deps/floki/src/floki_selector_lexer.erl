...
yystate(73, [38|Ics], Line, Tlen, Action, Alen) ->
    yystate(75, Ics, Line, Tlen+1, Action, Alen);
yystate(73, [36|Ics], Line, Tlen, Action, Alen) ->
...
yystate(73, [13|Ics], Line, Tlen, Action, Alen) ->
    yystate(71, Ics, Line, Tlen+1, Action, Alen);
yystate(73, [11|Ics], Line, Tlen, Action, Alen) ->
    yystate(75, Ics, Line, Tlen+1, Action, Alen);
yystate(73, [10|Ics], Line, Tlen, Action, Alen) ->
    yystate(71, Ics, Line+1, Tlen+1, Action, Alen);
yystate(73, [9|Ics], Line, Tlen, Action, Alen) ->
    yystate(71, Ics, Line, Tlen+1, Action, Alen);
yystate(73, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 8 ->
    yystate(75, Ics, Line, Tlen+1, Action, Alen);
yystate(73, [C|Ics], Line, Tlen, Action, Alen) when C >= 14, C =< 31 ->
    yystate(75, Ics, Line, Tlen+1, Action, Alen);
...
yystate(73, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 122 ->
    yystate(42, Ics, Line, Tlen+1, Action, Alen);
yystate(73, [C|Ics], Line, Tlen, Action, Alen) when C >= 127 ->
    yystate(75, Ics, Line, Tlen+1, Action, Alen);
...
yystate(63, [10|Ics], Line, Tlen, _, _) ->
    yystate(63, Ics, Line+1, Tlen+1, 23, Tlen);
...
yystate(59, [10|Ics], Line, Tlen, _, _) ->
    yystate(59, Ics, Line+1, Tlen+1, 21, Tlen);
...
yystate(57, [10|Ics], Line, Tlen, _, _) ->
    yystate(49, Ics, Line+1, Tlen+1, 25, Tlen);
yystate(57, Ics, Line, Tlen, _, _) ->
    {25,Tlen,Ics,Line,57};
yystate(56, [41|Ics], Line, Tlen, Action, Alen) ->
...
yystate(55, [10|Ics], Line, Tlen, _, _) ->
    yystate(55, Ics, Line+1, Tlen+1, 22, Tlen);
...
yystate(48, [69|Ics], Line, Tlen, Action, Alen) ->
    yystate(52, Ics, Line, Tlen+1, Action, Alen);
...
yystate(46, [58|Ics], Line, Tlen, Action, Alen) ->
...
yystate(39, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(39, Ics, Line, Tlen+1, Action, Alen);
yystate(39, [C|Ics], Line, Tlen, Action, Alen) when C >= 35 ->
    yystate(39, Ics, Line, Tlen+1, Action, Alen);
...
yystate(36, [86|Ics], Line, Tlen, Action, Alen) ->
    yystate(48, Ics, Line, Tlen+1, Action, Alen);
...
yystate(31, [10|Ics], Line, Tlen, _, _) ->
    yystate(39, Ics, Line+1, Tlen+1, 27, Tlen);
...
yystate(31, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 33 ->
    yystate(39, Ics, Line, Tlen+1, 27, Tlen);
yystate(31, [C|Ics], Line, Tlen, _, _) when C >= 35 ->
    yystate(39, Ics, Line, Tlen+1, 27, Tlen);
...
yystate(29, [78|Ics], Line, Tlen, _, _) ->
    yystate(25, Ics, Line, Tlen+1, 27, Tlen);
yystate(29, [72|Ics], Line, Tlen, _, _) ->
    yystate(6, Ics, Line, Tlen+1, 27, Tlen);
yystate(29, [45|Ics], Line, Tlen, _, _) ->
    yystate(2, Ics, Line, Tlen+1, 27, Tlen);
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(2, Ics, Line, Tlen+1, 27, Tlen);
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 71 ->
    yystate(2, Ics, Line, Tlen+1, 27, Tlen);
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 73, C =< 77 ->
    yystate(2, Ics, Line, Tlen+1, 27, Tlen);
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 79, C =< 90 ->
    yystate(2, Ics, Line, Tlen+1, 27, Tlen);
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 103 ->
    yystate(2, Ics, Line, Tlen+1, 27, Tlen);
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 105, C =< 109 ->
    yystate(2, Ics, Line, Tlen+1, 27, Tlen);
...
yystate(24, [110|Ics], Line, Tlen, Action, Alen) ->
    yystate(40, Ics, Line, Tlen+1, Action, Alen);
yystate(24, [78|Ics], Line, Tlen, Action, Alen) ->
    yystate(40, Ics, Line, Tlen+1, Action, Alen);
...
yystate(14, [45|Ics], Line, Tlen, _, _) ->
    yystate(2, Ics, Line, Tlen+1, 8, Tlen);
yystate(14, [40|Ics], Line, Tlen, _, _) ->
...
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(2, Ics, Line, Tlen+1, 8, Tlen);
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 82 ->
    yystate(2, Ics, Line, Tlen+1, 8, Tlen);
...
yystate(4, [10|Ics], Line, Tlen, _, _) ->
    yystate(0, Ics, Line+1, Tlen+1, 27, Tlen);
