  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      <article className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        {post.marketing?.enablePopup && post.marketing.popupContent && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl max-w-md mx-4">
              <div dangerouslySetInnerHTML={{ __html: post.marketing.popupContent }} />
              <button
                type="button"
        ...
        {/* Ad Slots */}
        {post.marketing?.enableAds && post.marketing.adSlots?.map((adSlot: { position: string; adCode: string }, index: number) => (
          <div
            key={index}
            className={`my-8 ${
