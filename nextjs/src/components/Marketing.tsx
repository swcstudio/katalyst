      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              <div className="text-3xl font-bold text-green-600">{marketingData?.stats.projects}</div>
              <div className="text-gray-600">Projects Built</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-purple-600">{marketingData?.stats.performance}</div>
              <div className="text-gray-600">Uptime</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-orange-600">{marketingData?.stats.satisfaction}</div>
