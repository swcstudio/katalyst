import { JSX, splitProps, createSignal, onMount, onCleanup, For } from "solid-js"
...
export function FloatingParticles(props: FloatingParticlesProps) {
  const [local, others] = splitProps(props, [
    "count", "size", "speed", "colors", "shape", "pattern", "density", 
    "interactive", "pause", "fadeEdges", "glow", "class"
  ])
  ...
  return (
    ...
    >
      <For each={particles()}>
        {(particle) => getShapeElement(particle)}
      </For>
