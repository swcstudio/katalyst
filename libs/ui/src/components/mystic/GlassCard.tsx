import { JSX, splitProps, children as resolveChildren, Show } from "solid-js"
import { cn, glassMorphism, animations, sizeVariants, shadows } from "./utils.ts"

export interface GlassCardProps extends JSX.HTMLAttributes<HTMLDivElement> {
  variant?: "light" | "medium" | "heavy" | "dark" | "rainbow" | "aurora" | "cosmic" | "ocean" | "forest"
  size?: "xs" | "sm" | "md" | "lg" | "xl"
...
export function GlassCard(props: GlassCardProps) {
  const [local, others] = splitProps(props, [
    "variant", "size", "blur", "shadow", "rounded", "border", "hoverable", 
    "animated", "children", "header", "footer", "overlay", "gradient", "class"
  ])
  ...
  const getVariantClasses = () => {
    const variants = {
      ...
      rainbow: "bg-gradient-to-br from-pink-500/20 via-purple-500/20 to-blue-500/20 border-white/20",
      ...
      forest: "bg-gradient-to-br from-green-600/20 via-emerald-600/20 to-teal-600/20 border-white/25"
    }
  ...
  const baseClasses = cn(
    ...
    // Focus styles
    local.hoverable && "focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:ring-offset-2",
  ...
  return (
    <div
      {...others}
      class={baseClasses}
      tabindex={local.hoverable ? 0 : undefined}
    >
      {/* Overlay effect */}
