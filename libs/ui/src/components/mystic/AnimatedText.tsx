import { JSX, splitProps, createSignal, createEffect, onCleanup } from "solid-js"
import { cn, animations, typography, gradients } from "./utils.ts"

export interface AnimatedTextProps {
  text: string
  variant?: "typewriter" | "fade" | "slide" | "wave" | "glitch" | "rainbow"
  gradient?: "primary" | "secondary" | "accent" | "sunset" | "ocean" | "forest" | "rainbow" | "midnight"
...
export function AnimatedText(props: AnimatedTextProps) {
  const [local, others] = splitProps(props, [
    "text", "variant", "gradient", "size", "speed", "delay", "repeat", 
    "cursor", "stagger", "shimmer", "as", "class", "id", "style"
  ])
