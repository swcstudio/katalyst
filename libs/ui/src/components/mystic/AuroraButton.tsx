...
import { cn, animations, sizeVariants } from "./utils.ts"
...
export function AuroraButton(props: AuroraButtonProps) {
  const [local, others] = splitProps(props, [
    "variant", "size", "loading", "disabled", "children", "class", 
  ...
  const getVariantClasses = () => {
    const variants = {
      aurora: "bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 hover:from-blue-600 hover:via-purple-600 hover:to-pink-600",
      cosmic: "bg-gradient-to-r from-purple-600 via-blue-600 to-cyan-600 hover:from-purple-700 hover:via-blue-700 hover:to-cyan-700",
      mystic: "bg-gradient-to-r from-violet-600 via-indigo-600 to-purple-600 hover:from-violet-700 hover:via-indigo-700 hover:to-purple-700",
      ocean: "bg-gradient-to-r from-blue-600 via-cyan-600 to-teal-600 hover:from-blue-700 hover:via-cyan-700 hover:to-teal-700",
      forest: "bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 hover:from-green-700 hover:via-emerald-700 hover:to-teal-700",
      sunset: "bg-gradient-to-r from-orange-500 via-pink-500 to-purple-600 hover:from-orange-600 hover:via-pink-600 hover:to-purple-700"
    }
