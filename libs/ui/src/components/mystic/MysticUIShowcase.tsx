...
import { AuroraButton, GlassCard, AnimatedText, FloatingParticles } from './index.ts';
      ...
      <div class={css({ 
        ...
        <div class={css({ position: 'relative' })}>
          ...
          {activeSection() === 'backgrounds' && (
            <div class={css({ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' })}>
              
              <GlassCard title="Dot Pattern" className={css({ height: '200px', position: 'relative' })}>
              ...
              <GlassCard title="Grid Pattern" className={css({ height: '200px', position: 'relative' })}>
              ...
              <GlassCard title="Retro Grid" className={css({ height: '200px', position: 'relative' })}>
              ...
              <GlassCard title="Ripple Effect" className={css({ height: '200px', position: 'relative' })}>
              ...
              <GlassCard title="No Signal Screen" className={css({ height: '200px', position: 'relative' })}>
          ...
          {activeSection() === 'components' && (
            <div class={css({ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' })}>
              ...
              <GlassCard title="Dock Component" className={css({ height: '300px', position: 'relative' })}>
                <div class={css({ 
                  position: 'absolute', 
                  bottom: '2rem', 
                  left: '50%', 
              ...
              <GlassCard title="Marquee" className={css({ height: '300px', position: 'relative' })}>
                ...
                <div class={css({ padding: '1rem' })}>
                  Smooth scrolling text marquee
                </div>
              </GlassCard>

              <GlassCard title="Orbiting Circles" className={css({ height: '300px', position: 'relative' })}>
                <div class={css({ 
                  position: 'absolute', 
                  top: '50%', 
                  left: '50%',
          ...
          {activeSection() === 'device-mocks' && (
            <div class={css({ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '2rem' })}>
              
              <GlassCard title="iPhone 15" className={css({ display: 'flex', justifyContent: 'center', padding: '2rem' })}>
                <iPhone15 
                  variant="pro"
                  size="sm"
              ...
              <GlassCard title="Android Phone" className={css({ display: 'flex', justifyContent: 'center', padding: '2rem' })}>
                <Android 
                  variant="pixel"
                  size="sm"
                >
              ...
              <GlassCard title="Safari Browser" className={css({ display: 'flex', justifyContent: 'center', padding: '1rem' })}>
                <Safari 
                  size="sm"
                  tabs={safariTabs}
          ...
          {activeSection() === 'effects' && (
            <div class={css({ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' })}>
              ...
              <GlassCard title="Border Beam" className={css({ height: '200px', position: 'relative' })}>
                <BorderBeam 
                  size={200}
                  duration={8}
                  colorFrom="#ffaa40"
              ...
              <GlassCard title="Animated Beam" className={css({ height: '200px', position: 'relative' })}>
                <div 
                  ref={setFromRef}
                  class={css({ 
                    position: 'absolute',
          ...
          {activeSection() === 'text-effects' && (
            <div class={css({ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' })}>
              ...
              <GlassCard title="Animated Shiny Text" className={css({ height: '200px', position: 'relative' })}>
                <div class={css({ 
                  position: 'absolute',
                  top: '50%',
                  left: '50%',
              ...
              <GlassCard title="Typing Animation" className={css({ height: '200px', position: 'relative' })}>
                <div class={css({ 
                  position: 'absolute',
                  top: '50%',
                  left: '50%',
          ...
          {activeSection() === 'original' && (
            <div class={css({ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' })}>
              ...
              <GlassCard title="Aurora Button" className={css({ height: '200px', position: 'relative' })}>
                <div class={css({ 
                  position: 'absolute',
                  top: '50%',
                  left: '50%',
              ...
              <GlassCard title="Glass Card" className={css({ height: '200px', position: 'relative' })}>
                <div class={css({ padding: '1rem' })}>
              ...
              <GlassCard title="Animated Text" className={css({ height: '200px', position: 'relative' })}>
                <div class={css({ 
                  position: 'absolute',
                  top: '50%',
                  left: '50%',
