...
import { createMemo, createUniqueId, JSX, splitProps, For, Show } from "solid-js"
...
export function Tabs(props: TabsProps) {
  const [local, others] = splitProps(props, [
    "items", "defaultValue", "value", "orientation", "activationMode", 
    "disabled", "id", "class", "listClass", "tabClass", "panelClass", "onValueChange"
  ])
  ...
  const tabClasses = (item: TabItem) => {
    const base = "px-4 py-2 text-sm font-medium rounded-t-lg transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
    ...
    const vertical = local.orientation === "vertical" ? "rounded-l-lg rounded-t-none border-b-0 border-r-2" : ""
