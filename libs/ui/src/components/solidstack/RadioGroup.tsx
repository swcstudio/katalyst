...
export function RadioGroup(props: RadioGroupProps) {
  const [local, others] = splitProps(props, [
    "options", "value", "defaultValue", "name", "disabled", "invalid", 
    "required", "orientation", "id", "class", "radioClass", "label", 
    "helperText", "errorText", "onChange", "onValueChange"
  ])
  ...
  const radioButtonClasses = (option: RadioOption) => {
    const base = "relative flex h-4 w-4 shrink-0 items-center justify-center rounded-full border-2 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
