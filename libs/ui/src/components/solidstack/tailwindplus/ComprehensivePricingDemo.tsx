      ...
      case "PricingTable":
        return (
          <PricingTable
            ...
            title={variant.theme === "dark" ? "Pricing that scales" : "Choose the right plan for you"}
            subtitle={variant.theme === "dark"
        ...
        <div class={headerContentStyles}>
          ...
          <BlurFade delay={0.2} inView>
            <p class={subtitleStyles}>
              State-of-the-art pricing components with Zag.js state machines, PandaCSS styling, 
