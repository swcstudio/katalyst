        ...
        switch (merged.variant) {
          case 'cards':
            return css({
              ...
              p: '8',
              rounded: '2xl',
              border: merged.theme === 'dark' ? '1px solid rgba(255,255,255,0.1)' : '1px solid rgba(0,0,0,0.05)',
              _hover: {
      ...
      >
        ...
        >
          ...
          <Show when={cardProps.stat.description}>
            <div class={css({
              fontSize: 'sm',
              color: merged.variant === 'background' ? 'gray.300' : (merged.theme === 'dark' ? 'gray.400' : 'gray.500'),
              lineHeight: '6',
              mt: '2'
            })}>
            ...
            <div class={css({
              ...
              <Show when={merged.title}>
                <h2 class={css({
                  ...
                  letterSpacing: 'tight',
                  textWrap: 'pretty',
                  color: merged.variant === 'background' ? 'white' : (merged.theme === 'dark' ? 'white' : 'gray.900'),
                  sm: { fontSize: '5xl' }
                })}>
                  {merged.title}
                </h2>
              ...
              <Show when={merged.subtitle}>
                <p class={css({
                  ...
                  fontSize: 'lg',
                  lineHeight: '8',
                  color: merged.variant === 'background' ? 'gray.300' : (merged.theme === 'dark' ? 'gray.300' : 'gray.600')
                })}>
                  {merged.subtitle}
                </p>
              </Show>
