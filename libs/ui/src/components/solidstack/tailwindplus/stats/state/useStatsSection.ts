...
export function useStatsSection(options: StatsSectionMachineOptions = {}): StatsSectionAPI {
    ...
    switch (state.context.sortOrder) {
      case 'value':
        return [...stats].sort((a, b) => {
          const aVal = typeof a.value === 'number' ? a.value : parseFloat(a.value.toString())
          const bVal = typeof b.value === 'number' ? b.value : parseFloat(b.value.toString())
          return bVal - aVal
        })
      case 'name':
  ...
  return {
    ...
    // Context accessors
    get statsData() { return state.context.statsData },
    get activeStatId() { return state.context.activeStatId },
    get hoveredStatId() { return state.context.hoveredStatId },
    get visibleStats() { return state.context.visibleStats },
    get animatedStats() { return state.context.animatedStats },
    get completedStats() { return state.context.completedStats },
    ...
    get countersEnabled() { return state.context.countersEnabled },
    ...
    // Computed properties
    get filteredStats() { return filteredStats() },
    get sortedStats() { return sortedStats() },
