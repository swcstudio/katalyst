import { Component, JSX, onMount, createSignal, For } from "solid-js";
        ...
        <nav class={navStyles}>
          <div class={logoStyles}>
            <a href="/">
              ...
              <img
                src={props.logo?.src || "https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=600"}
          ...
          <For each={navigation()}>
            {(item) => (
              <a 
                href={item.href} 
                class={navLinkStyles}
                style={{ padding: "12px 0", "border-bottom": `1px solid ${theme() === "dark" ? "#374151" : "#e5e7eb"}` }}
                onClick={nav.closeMobileMenu}
              >
                {item.name}
              </a>
