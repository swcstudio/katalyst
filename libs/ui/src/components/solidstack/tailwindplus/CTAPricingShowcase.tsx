    ...
    <div class={showcaseStyles}>
      ...
      <div class={sectionStyles}>
        <div class={sectionHeaderStyles}>
          ...
          <p class={sectionDescStyles}>Perfect for straightforward calls-to-action with beautiful animations</p>
        </div>
      ...
      <div class={sectionStyles}>
        <div class={sectionHeaderStyles}>
          ...
          <p class={sectionDescStyles}>Stand out with beautiful colored backgrounds and contrasting text</p>
        </div>
      ...
      <div class={sectionStyles}>
        <div class={sectionHeaderStyles}>
          ...
          <p class={sectionDescStyles}>Eye-catching gradient backgrounds with animated warp effects</p>
        </div>
      ...
      <div class={sectionStyles}>
        <div class={sectionHeaderStyles}>
          ...
          <p class={sectionDescStyles}>Clean pricing tables with frequency switching and beautiful animations</p>
        </div>
      ...
      <div class={sectionStyles}>
        <div class={sectionHeaderStyles}>
          ...
          <p class={sectionDescStyles}>Three-tier pricing with popular indicators and featured highlights</p>
        </div>
