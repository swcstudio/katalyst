...
const sampleBlogData: BlogSection = {
  ...
  posts: [
    ...
    },
    {
      ...
      href: '#',
      description: 'Optio cum necessitatibus dolor voluptatum provident commodi et. Qui aperiam fugiat nemo cumque. Et voluptas consequatur magni sapiente amet voluptates dolorum.',
      date: 'Mar 10, 2020',
      datetime: '2020-03-10',
    ...
    },
    {
      ...
      href: '#',
      description: 'Cupiditate maiores ullam eveniet adipisci in doloribus nulla minus. Voluptas iusto libero adipisci rem et corporis. Sint harum rerum voluptatem quo recusandae magni placeat saepe molestiae.',
      date: 'Feb 12, 2020',
      datetime: '2020-02-12',
    ...
    },
    {
      ...
      href: '#',
      description: 'Ipsum voluptates quia doloremque culpa qui eius. Id qui id officia molestias quaerat deleniti. Qui facere numquam autem libero quae cupiditate asperiores vitae cupiditate.',
      date: 'Jan 29, 2020',
      datetime: '2020-01-29',
      ...
      imageUrl: 'https://images.unsplash.com/photo-1455390582262-044cdead277a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1679&q=80',
      readingTime: '5 min',
      featured: true,
    ...
    },
    {
      ...
      imageUrl: 'https://images.unsplash.com/photo-1558655146-d09347e92766?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1679&q=80',
      readingTime: '12 min',
    ...
    },
    {
      ...
      href: '#',
      description: 'Velit facilis asperiores porro quaerat doloribus, eveniet dolore. Adipisci tempora aut inventore optio animi, tempore temporibus quo laudantium.',
      date: 'Dec 20, 2019',
      datetime: '2019-12-20',
      ...
      imageUrl: 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1679&q=80',
      readingTime: '10 min',
...
const variants = [
  ...
  { id: 'overlay', name: 'Overlay Hero', description: 'Dramatic overlay design with background effects' },
  { id: 'list', name: 'Timeline List', description: 'Timeline-style list with sequential animations' }
];
      ...
      <div class={showcaseHeaderStyles}>
        ...
        <BlurFade delay={0.2} inView={isVisible()}>
          <p class={showcaseSubtitleStyles}>
            Beautiful, animated blog components with state machine architecture and native Magic UI & Aceternity augmentations.
          </p>
        </BlurFade>
      </div>
          ...
          <For each={variants}>
            {(variant) => (
              <div class="text-center">
                ...
                <p class={variantDescriptionStyles}>
                  {variant.description}
                </p>
              </div>
            )}
          ...
          <div class={css({
            ...
            <div class={css({
              ...
              <div>
                ...
                <ul class={css({ fontSize: 'sm', color: 'gray.600', listStyle: 'disc', paddingLeft: '4' })}>
