import { type Component, createSignal, For, JSX, onMount, Show } from 'solid-js';
...
export const SupportNewsletterShowcase: Component = () => {
  ...
  const renderActiveComponent = () => {
    ...
    if (selected.component === 'support') {
      return (
        <SupportCenter
          ...
          heroImage={
            selected.variant === 'hero' || selected.variant === 'split'
    ...
    if (selected.component === 'newsletter') {
      return (
        ...
        <div class={headerContentStyles}>
          ...
          <BlurFade delay={0.2} inView>
            <p class={subtitleStyles}>
              State-of-the-art support center and newsletter subscription components with Zag.js
              state machines, PandaCSS styling, and thoughtful animation augmentations.
            </p>
          </BlurFade>
