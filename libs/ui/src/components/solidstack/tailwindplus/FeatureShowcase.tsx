    ...
    <div class={containerStyles}>
      <div class={headerStyles}>
        ...
        <p class={subtitleStyles}>
          Professional feature sections with split layouts, grid displays, and minimal presentations. 
          All components include state machine architecture, beautiful animations, and theme support.
        </p>
      </div>
      ...
      <div style={{
        ...
        <p style={{
          ...
          From simple product showcases to complex feature comparisons, these components adapt to your content needs 
          while maintaining consistent design and performance.
        </p>
        <div style={{
          display: "flex",
          gap: "16px",
