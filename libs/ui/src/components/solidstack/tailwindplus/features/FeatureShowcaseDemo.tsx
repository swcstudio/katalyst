    ...
    <div class={showcaseStyles}>
      <div class={headerStyles}>
        ...
        <p class={subtitleStyles}>
          Beautiful, animated feature sections built with Zag.js state machines, SolidJS, and Magic
          UI animations
        </p>
      ...
      <div class={sectionStyles}>
        <div class={sectionHeaderStyles}>
          ...
          <p class={sectionDescStyles}>
            Perfect for showcasing key features with icons and descriptions
          </p>
        </div>
      ...
      <div class={sectionStyles}>
        <div class={sectionHeaderStyles}>
          ...
          <p class={sectionDescStyles}>
            Image on left with gradient background and centered content
          </p>
        </div>
        ...
        <FeatureSimpleList
          ...
          features={[
            ...
            },
            {
              ...
              description:
                'Comprehensive insights into your application performance with real-time monitoring and detailed reporting capabilities.',
              icon: 'cloud',
            },
          ]}
          theme={currentTheme()}
