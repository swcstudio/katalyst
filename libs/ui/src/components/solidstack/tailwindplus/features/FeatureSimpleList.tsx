...
export const FeatureSimpleList: Component<FeatureSimpleListProps> = (props) => {
  ...
  const featuresContainerStyles = css({
    display: "grid",
    gridTemplateColumns: layout() === "single" ? "1fr" :
                        layout() === "two-column" ? "1fr" :
                        "1fr",
    gap: "32px",
    "@media (min-width: 640px)": {
      gridTemplateColumns: layout() === "two-column" ? "repeat(2, 1fr)" :
                          layout() === "three-column" ? "repeat(2, 1fr)" :
                          "1fr",
      gap: "40px 48px",
    },
    "@media (min-width: 1024px)": {
      gridTemplateColumns: layout() === "three-column" ? "repeat(3, 1fr)" :
                          layout() === "two-column" ? "repeat(2, 1fr)" :
                          "1fr",
      gap: "48px 64px",
    },
  });
