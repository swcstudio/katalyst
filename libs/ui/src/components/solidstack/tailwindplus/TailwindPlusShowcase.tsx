...
export const TailwindPlusShowcase: Component = () => {
  ...
  const showcaseItems: ShowcaseItem[] = [
    ...
    },
    {
      ...
      description: "Split layout with content on left and image on right, includes stats and advanced animations",
      component: HeroSplit,
      props: {
        title: "Deploy to the cloud with confidence",
        subtitle: "Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat.",
    ...
    },
    {
      ...
      props: {
        ...
        video: {
          thumbnail: "https://images.unsplash.com/photo-1556740758-90de374c12ad?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
    ...
    <div class={containerStyles}>
      <div class={headerStyles}>
        ...
        <p class={subtitleStyles}>
          Professional hero sections with state machine architecture, beautiful animations, and modern design patterns. 
          Built with SolidJS, Zag.js, and enhanced with Magic UI animations.
        </p>
      </div>
      ...
      <div style={{
        ...
        <p style={{
          ...
          All components are production-ready, fully documented, and designed to work seamlessly together. 
