...
/>`
    },
    {
      ...
      props: {
        ...
        subtitle: "Streamline your development process with our integrated tools and automated workflows.",
        primaryButton: {
          text: "Get Started",
          href: "#"
        },
...
/>`
    },
    {
      ...
      props: {
        ...
        subtitle: "Watch how teams are building and deploying applications faster than ever before.",
        primaryButton: {
          text: "Start Free Trial",
          href: "#"
        },
    ...
    <div class={containerStyles}>
      ...
      <div class={mainContentStyles}>
        ...
        <div class={demoSectionStyles}>
          {mounted() && demoSections[activeSection()].component(demoSections[activeSection()].props)}
