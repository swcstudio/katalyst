...
export const PricingSplit: Component<PricingSplitProps> = (props) => {
  ...
  const tierCardStyles = (tier: PricingTier, isCenterTier = false) =>
    css({
      position: 'relative',
      display: 'flex',
      height: '100%',
  ...
  const tierContentStyles = (isCenterTier = false) =>
    css({
  ...
  const tierNameStyles = (isCenterTier = false) =>
    css({
  ...
  const priceStyles = (isCenterTier = false) =>
    css({
  ...
  const featuresContainerStyles = (isCenterTier = false) =>
    css({
      display: 'flex',
      flex: '1',
      flexDirection: 'column',
  ...
  const ctaButtonStyles = (tier: PricingTier, isCenterTier = false) =>
    css({
      display: 'block',
      width: '100%',
      borderRadius: '12px',
