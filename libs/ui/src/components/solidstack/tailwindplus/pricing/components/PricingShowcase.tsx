...
const tablePricingTiers = [
  { id: "starter", name: "Starter", price: { monthly: "$19", annually: "$190" }, mostPopular: false },
...
export const PricingShowcase: Component<PricingShowcaseProps> = (props) => {
  ...
  const demoButtonStyles = (active: boolean) => css({
    paddingX: "16px",
    paddingY: "8px",
    borderRadius: "8px",
    fontSize: "14px",
      ...
      <div class={headerStyles}>
        ...
        <BlurFade delay={0.2} inView>
          <p class={subtitleStyles}>
            Comprehensive collection of pricing components with state-of-the-art animations and Zag.js state management.
            Choose from various layouts and themes to fit your design needs.
          </p>
        </BlurFade>
      ...
      <Show when={shouldShowDemo("split")}>
        <section class={sectionStyles}>
          <div class={sectionHeaderStyles}>
            ...
            <p class={sectionDescriptionStyles}>
              Highlight your most popular plan with enhanced visual emphasis and gradient backgrounds
            </p>
          </div>
          <PricingSplit
            badge="Most Popular"
