...
export const PricingGrid: Component<PricingGridProps> = (props) => {
  ...
  const radioButtonStyles = (selected: boolean) => css({
    ...
    "&:hover": {
      backgroundColor: selected ? (theme() === "dark" ? "#5b21b6" : "#4338ca") : (theme() === "dark" ? "rgba(255, 255, 255, 0.1)" : "rgba(0, 0, 0, 0.1)"),
    },
  });
  ...
  const tierCardStyles = (tier: PricingTier) => css({
    position: "relative",
    borderRadius: "24px",
    padding: "32px",
    backgroundColor: theme() === "dark" ? (tier.mostPopular ? "rgba(255, 255, 255, 0.05)" : "#1f2937") : "#ffffff",
    boxShadow: theme() === "dark" ? "0 10px 15px -3px rgba(0, 0, 0, 0.5)" : "0 10px 15px -3px rgba(0, 0, 0, 0.1)",
    border: tier.mostPopular ? `2px solid ${theme() === "dark" ? "#6366f1" : "#4f46e5"}` : `1px solid ${theme() === "dark" ? "rgba(255, 255, 255, 0.1)" : "#e5e7eb"}`,
    transition: "all 0.3s ease-in-out",
    "&:hover": {
      transform: "translateY(-4px)",
      boxShadow: theme() === "dark" ? "0 20px 25px -5px rgba(0, 0, 0, 0.7)" : "0 20px 25px -5px rgba(0, 0, 0, 0.15)",
    },
  ...
  const ctaButtonStyles = (tier: PricingTier) => css({
    marginTop: "24px",
    display: "block",
    borderRadius: "8px",
    paddingX: "12px",
    ...
    lineHeight: "24px",
    fontWeight: "600",
    backgroundColor: tier.mostPopular ? (theme() === "dark" ? "#6366f1" : "#4f46e5") : (theme() === "dark" ? "rgba(255, 255, 255, 0.1)" : "#f9fafb"),
    color: tier.mostPopular ? "#ffffff" : (theme() === "dark" ? "#ffffff" : "#4f46e5"),
    border: tier.mostPopular ? "none" : `1px solid ${theme() === "dark" ? "rgba(255, 255, 255, 0.2)" : "#e5e7eb"}`,
    transition: "all 0.2s ease-in-out",
    cursor: "pointer",
    "&:hover": {
      backgroundColor: tier.mostPopular ? (theme() === "dark" ? "#5b21b6" : "#4338ca") : (theme() === "dark" ? "rgba(255, 255, 255, 0.2)" : "#f3f4f6"),
    },
  });
