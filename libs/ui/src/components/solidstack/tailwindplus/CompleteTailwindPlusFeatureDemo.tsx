  ...
  const demoSections: DemoSection[] = [
    {
      ...
      props: {
        ...
        subtitle: "Transform your ideas into reality with our comprehensive platform. Designed for developers, built for scale.",
        primaryButton: { text: "Get Started", href: "#" },
        secondaryButton: { text: "Learn More", href: "#" },
        announcement: { text: "🎉 Announcing our Series A funding", linkText: "Read more", href: "#" },
...
/>`
    },
    {
      ...
      props: {
        ...
        subtitle: "Scale your applications effortlessly with our enterprise-grade infrastructure and developer-first tools.",
...
/>`
    },
    {
      ...
      props: {
        ...
        subtitle: "Build, deploy, and scale applications with ease. Our platform provides everything you need from development to production.",
        primaryButton: { text: "Start Building", href: "#" },
        secondaryButton: { text: "Live Demo", href: "#" },
        announcement: { badge: "New", text: "Advanced analytics dashboard", linkText: "Explore features", href: "#" },
        image: { src: "https://tailwindcss.com/plus-assets/img/component-images/project-app-screenshot.png", alt: "Platform dashboard" },
        stats: [
...
/>`
    },
    {
      ...
      props: {
        ...
        subtitle: "Enterprise-grade solutions designed to scale with your business needs and accelerate growth.",
        primaryButton: { text: "Contact Sales", href: "#" },
        secondaryButton: { text: "View Pricing", href: "#" },
        announcement: { badge: "Enterprise", text: "SOC 2 Type II certified", linkText: "Learn more", href: "#" },
        image: { src: "https://tailwindcss.com/plus-assets/img/component-images/dark-project-app-screenshot.png", alt: "Enterprise dashboard" },
        stats: [
...
/>`
    },
    {
      ...
      props: {
        ...
        image: { src: "https://tailwindcss.com/plus-assets/img/component-images/dark-project-app-screenshot.png", alt: "Product screenshot" },
        layout: "imageRight",
        theme: "light",
        animated: true,
        backgroundPattern: "dots",
...
/>`
    },
    {
      ...
      props: {
        ...
        image: { src: "https://tailwindcss.com/plus-assets/img/component-images/project-app-screenshot.png", alt: "App screenshot" },
        theme: "light",
        animated: true,
        backgroundPattern: "dots",
        imageOverlay: true,
...
/>`
    },
    {
      ...
      props: {
        ...
        subtitle: "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis.",
        features: extendedFeaturesData,
        image: { src: "https://tailwindcss.com/plus-assets/img/component-images/dark-project-app-screenshot.png", alt: "App screenshot" },
        theme: "dark",
        animated: true,
        backgroundPattern: "dots",
        imageOverlay: true,
  ...
  return (
    <div class={containerStyles}>
      ...
      <div class={sidebarStyles}>
        <div style={{ "margin-bottom": "32px" }}>
          ...
          <p style={{ "font-size": "14px", "opacity": "0.8", "line-height": "1.4" }}>
            Complete showcase of enterprise components with state machines, animations, and modern design patterns
          </p>
        </div>
        ...
        <div>
          <h2 style={{ "font-size": "12px", "font-weight": "600", "text-transform": "uppercase", "letter-spacing": "0.05em", "margin-bottom": "16px", "color": "#94a3b8" }}>
        ...
        <div style={{ "margin-top": "32px", "padding-top": "24px", "border-top": "1px solid #334155" }}>
          <h3 style={{ "font-size": "12px", "font-weight": "600", "margin-bottom": "12px", "color": "#94a3b8" }}>
            Architecture
          </h3>
      ...
      <div class={mainContentStyles}>
        ...
        <div class={headerStyles}>
          ...
          <div style={{ "display": "flex", "align-items": "center", "gap": "16px" }}>
            ...
            <div style={{ 
              "padding": "4px 8px", 
              "background-color": filteredSections()[activeSection()]?.category === "hero" ? "#059669" : "#7c3aed",
              "color": "white", 
              "border-radius": "4px", 
              "font-size": "10px", 
              "font-weight": "600",
        ...
        <div class={demoSectionStyles}>
          {mounted() && filteredSections()[activeSection()]?.component(filteredSections()[activeSection()]?.props)}
          
          {/* Code Preview */}
          <div class={codePreviewStyles}>
            <div style={{ "font-weight": "600", "margin-bottom": "12px", "color": "#60a5fa", "display": "flex", "align-items": "center", "gap": "8px" }}>
              <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M12.316 3.051a1 1 0 01.633 1.265l-4 12a1 1 0 11-1.898-.632l4-12a1 1 0 011.265-.633zM5.707 6.293a1 1 0 010 1.414L3.414 10l2.293 2.293a1 1 0 11-1.414 1.414l-3-3a1 1 0 010-1.414l3-3a1 1 0 011.414 0zm8.586 0a1 1 0 011.414 0l3 3a1 1 0 010 1.414l-3 3a1 1 0 11-1.414-1.414L16.586 10l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
              </svg>
              Component Code
            </div>
            <pre style={{ "white-space": "pre-wrap", "font-size": "11px", "line-height": "1.5", "color": "#e2e8f0" }}>
      ...
      <div style={{
        ...
        <button
          onClick={() => setActiveSection(Math.min(filteredSections().length - 1, activeSection() + 1))}
      ...
      <div style={{
        ...
        <div style={{ "line-height": "1.4" }}>
          ...
          <div>⭐ {demoSections.filter(s => s.category === "feature").length} Feature Variants</div>
