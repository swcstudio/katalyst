...
const supportCards = [
  {
    id: "sales",
    name: "Sales Team",
    description: "Get help with pricing, quotes, and product demonstrations from our sales experts.",
    icon: () => (
      <svg fill="currentColor" viewBox="0 0 20 20" class={css({ width: "100%", height: "100%" })}>
  ...
  },
  {
    ...
    description: "Resolve technical issues, bugs, and get implementation assistance from our engineering team.",
    icon: () => (
      <svg fill="currentColor" viewBox="0 0 20 20" class={css({ width: "100%", height: "100%" })}>
        <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" />
      </svg>
  ...
  },
  {
    id: "community",
    name: "Community",
    description: "Connect with other developers, share experiences, and learn from community discussions.",
    icon: () => (
      <svg fill="currentColor" viewBox="0 0 20 20" class={css({ width: "100%", height: "100%" })}>
...
const newsletterFeatures = [
  ...
  },
  {
    ...
    icon: () => (
      <svg fill="currentColor" viewBox="0 0 20 20" class={css({ width: "100%", height: "100%" })}>
        <path fillRule="evenodd" d="M1 2.75A.75.75 0 011.75 2h16.5a.75.75 0 010 1.5H18v8.75A2.75 2.75 0 0115.25 15h-1.072l-3.401 3.402c-.57.57-1.505.57-2.075 0L5.823 15H4.75A2.75 2.75 0 012 12.25V3.5h-.25A.75.75 0 011 2.75z" clipRule="evenodd" />
      </svg>
    ),
...
export const TailwindPlusAdvancedDemo: Component = () => {
  ...
  const categoryCardStyles = (active: boolean) => css({
    position: "relative",
    padding: "24px",
    borderRadius: "16px",
        ...
        <BlurFade delay={0.1} inView>
          <div class={sectionHeaderStyles}>
            ...
            <p class={sectionDescriptionStyles}>
              Enterprise-grade pricing tables with state machine architecture and beautiful animations
            </p>
          </div>
        </BlurFade>
  ...
  const renderCategoryContent = () => {
    switch (activeCategory()) {
      case "pricing":
        return <PricingDemo theme={theme()} animated={true} className={css({ backgroundColor: theme() === "dark" ? "#111827" : "#ffffff" })} />;
        ...
        <div class={headerContentStyles}>
          ...
          <BlurFade delay={0.2} inView>
            <p class={subtitleStyles}>
              State-of-the-art UI components with Zag.js state machines, PandaCSS styling, 
              and thoughtful animation augmentations from Aceternity UI & Magic UI.
            </p>
          </BlurFade>
          ...
          <BlurFade delay={0.3} inView>
            <div class={navigationStyles}>
              ...
              <div class={themeToggleStyles}>
                <div class={css({ display: "flex", gap: "4px", backgroundColor: "rgba(255, 255, 255, 0.1)", borderRadius: "12px", padding: "4px" })}>
                  <button
      ...
      <footer class={css({
        ...
        <div class={css({
          ...
          <p class={css({
            ...
            SolidStack-UI combines the best of SolidJS reactivity, Zag.js state machines, 
            PandaCSS styling, and beautiful animations to create enterprise-grade components.
          </p>
