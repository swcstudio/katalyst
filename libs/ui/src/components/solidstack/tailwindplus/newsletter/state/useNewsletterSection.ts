...
export interface NewsletterSectionAPI {
  ...
  updateFormData: (field: keyof NewsletterFormData, value: string | string[] | boolean) => void;
...
export function useNewsletterSection(): NewsletterSectionAPI {
  ...
  const updateFormData = (field: keyof NewsletterFormData, value: string | string[] | boolean) => {
  ...
  const canSubmit = (): boolean => {
    return (
      isFormValid() && context.formState !== 'submitting' && context.formState !== 'validating'
    );
  };
