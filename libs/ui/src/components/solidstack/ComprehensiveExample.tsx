  ...
  const accordionItems: AccordionItem[] = [
    {
      ...
      content:
        'This comprehensive example showcases all available Zag.js components integrated with SolidJS and styled with Tailwind CSS.',
    },
    {
      title: '🎯 Features',
      content:
        'All components are fully accessible, keyboard navigable, and follow WAI-ARIA guidelines. They use Zag.js state machines for robust interaction logic.',
    },
    {
      title: '🛠️ Technical Details',
      content:
        'Built with TypeScript, SolidJS reactive primitives, and framework-agnostic Zag.js state machines. Styled with Tailwind CSS utility classes.',
    },
  ];
      ...
      <div class="max-w-6xl mx-auto space-y-8">
        ...
        <div class="text-center">
          ...
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            A comprehensive showcase of all Zag.js components integrated with SolidJS. Each
            component demonstrates accessibility, keyboard navigation, and proper state management.
          </p>
        </div>
