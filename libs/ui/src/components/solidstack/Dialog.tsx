...
export function Dialog(props: DialogProps) {
  const [local, others] = splitProps(props, [
    "open", "defaultOpen", "modal", "closeOnInteractOutside", "closeOnEscape",
    "preventScroll", "restoreFocus", "id", "class", "overlayClass", "contentClass",
    "title", "description", "children", "trigger", "onOpenChange", "onClose"
  ])
