import { Component, JSX, mergeProps, createSignal, onMount, children } from 'solid-js';
      ...
      <div class={css({
        ...
        <div
          class={css({
            ...
            width: '200%',
            height: '200%',
            background: 'radial-gradient(ellipse 80% 50% at 20% 40%, rgba(120, 119, 198, 0.3), transparent), radial-gradient(ellipse 80% 80% at 80% 50%, rgba(120, 119, 198, 0.15), transparent)',
        ...
        <div
          class={css({
            ...
            width: '200%',
            height: '200%',
            background: 'radial-gradient(ellipse 60% 80% at 70% 30%, rgba(184, 148, 255, 0.4), transparent), radial-gradient(ellipse 90% 70% at 30% 70%, rgba(184, 148, 255, 0.2), transparent)',
        ...
        <div
          class={css({
            ...
            width: '200%',
            height: '200%',
            background: 'radial-gradient(ellipse 100% 60% at 50% 60%, rgba(255, 154, 158, 0.3), transparent), radial-gradient(ellipse 70% 100% at 80% 20%, rgba(255, 154, 158, 0.15), transparent)',
        ...
        {merged.showRadialGradient && (
          <div
            class={css({
              position: 'absolute',
              inset: 0,
              background: 'radial-gradient(circle at 50% 50%, transparent 20%, rgba(0, 0, 0, 0.6) 80%)',
            })}
          />
        )}
      </div>
