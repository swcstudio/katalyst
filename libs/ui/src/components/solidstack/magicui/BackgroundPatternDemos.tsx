...
const DemoCard: Component<DemoCardProps> = (props) => {
  ...
  return (
    <div class={cardStyles}>
      ...
      <div class={demoContainerStyles}>{props.children}</div>
    </div>
  );
};
  ...
  return (
    <div class={containerStyles}>
      ...
      <div class={gridStyles}>
        ...
        <DemoCard title="Retro Grid" description="80s-style perspective grid with neon colors">
          <div class={demoHeightStyles}>
            <div
              style={{
                position: 'relative',
        ...
        <DemoCard title="Dot Pattern" description="Simple dot pattern with radial mask">
          <div class={demoHeightStyles}>
        ...
        <DemoCard title="Dot Pattern (Glow Effect)" description="Dot pattern with glowing effect">
          <div class={demoHeightStyles}>
            <DotPattern
              glow={true}
        ...
        <DemoCard title="Grid Pattern" description="Grid pattern with highlighted squares">
          <div class={demoHeightStyles}>
            <GridPattern
              squares={[
                [4, 4],
        ...
        <DemoCard title="Grid Pattern (Dashed)" description="Dashed grid pattern with radial mask">
          <div class={demoHeightStyles}>
            <GridPattern
              width={30}
              height={30}
