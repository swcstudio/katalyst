...
export const LayoutGrid: Component<LayoutGridProps> = (props) => {
  ...
  return (
    <div class={css({ width: '100%', height: '100%', padding: '40px', maxWidth: '1400px', marginX: 'auto', position: 'relative' })}>
      <div class={css({
        display: 'grid',
            ...
            <div class={cx(card.className)}>
              ...
              >
                ...
                <div class={css({
                  ...
                  <div class={css({ color: 'white', zIndex: 10 })}>
                    {card.content}
                  </div>
                </div>
              </div>
        ...
        <div class={css({
          ...
          >
            ...
            <div class={css({
              ...
              <div class={css({ color: 'white', fontSize: 'xl' })}>
                {selected()!.content}
              </div>
            </div>
          </div>
...
const SkeletonOne: Component = () => {
  return (
    <div>
      ...
      <p class={css({ fontWeight: 'normal', fontSize: 'base', color: 'white' })}></p>
      <p class={css({
        fontWeight: 'normal',
        fontSize: 'base',
        marginY: '16px',
