    ...
    <div class={css({
      ...
      <section class={css({
        ...
        <div class={css({
          ...
          <div class={css({ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px' })}>
      ...
      <section class={css({
        ...
        <div class={css({
          ...
          <div class={css({
            ...
            <div class={css({ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' })}>
              <ConfettiButtonDemo />
              <ConfettiFireworks />
              <ConfettiStars />
            </div>
      ...
      <section class={css({
        ...
        <div class={css({
          ...
          <div class={css({
            ...
            <h3 class={css({ marginBottom: '16px', fontSize: '18px', fontWeight: '600', textAlign: 'center' })}>
