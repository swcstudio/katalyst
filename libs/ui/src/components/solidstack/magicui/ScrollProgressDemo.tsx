    ...
    <div class={css({
      ...
      <div class={css({
        ...
        <p class={css({
          ...
          Scroll down to see the progress bar in action. The blue bar at the top 
          will fill as you scroll through the page content.
        </p>
        
        {/* Generate content for scrolling */}
        <div class={css({
          height: '200vh',
          background: 'linear-gradient(to bottom, transparent, gray.50, gray.100, gray.50, transparent)',
          borderRadius: 'lg',
          padding: '8',
          display: 'flex',
          alignItems: 'center',
          ...
          _dark: {
            background: 'linear-gradient(to bottom, transparent, gray.900, gray.800, gray.900, transparent)',
          },
        })}>
          <div class={css({
            textAlign: 'center',
