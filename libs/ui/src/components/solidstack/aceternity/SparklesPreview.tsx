        ...
        <Motion variant="fadeInUp" delay={0.6} duration={0.8}>
          <div class={css({
            ...
            <div class={css({
              ...
              insetX: '20',
              top: '0',
              background: 'linear-gradient(to right, transparent, rgb(99, 102, 241), transparent)', // indigo-500
              height: '2px',
              width: '3/4',
              filter: 'blur(1px)',
            })} />
            ...
            <div class={css({
              ...
              insetX: '60',
              top: '0',
              background: 'linear-gradient(to right, transparent, rgb(14, 165, 233), transparent)', // sky-500
              height: '5px',
              width: '1/4',
              filter: 'blur(1px)',
            })} />
