...
export const TailwindcssButtons: Component = () => {
  const copy = (button: any) => {
    ...
    let buttonString = button.component.toString();
  ...
  return (
    <div class={css({ paddingBottom: '40', paddingX: '4', width: 'full' })}>
      ...
      <div class={css({
        ...
        <For each={buttons}>
          {(button, idx) => (
            <ButtonsCard onClick={() => copy(button)}>
              {button.component}
            </ButtonsCard>
          )}
        </For>
      ...
      <button class={css({
        ...
        <span class={css({
          ...
          <span class={css({
            ...
            inset: '0',
            borderRadius: 'full',
            backgroundImage: 'radial-gradient(75% 100% at 50% 0%, rgba(56,189,248,0.6) 0%, rgba(56,189,248,0) 75%)',
            opacity: '0',
        ...
        <span class={css({
          ...
          background: 'linear-gradient(to right, rgba(52,211,153,0) 0%, rgba(52,211,153,0.9) 50%, rgba(52,211,153,0) 100%)',
          transition: 'opacity 0.5s',
          opacity: '0',
  ...
  },
  {
    ...
    component: (
      <button class={css({
        ...
        transition: 'all 0.2s',
        fontSize: 'sm',
        boxShadow: '1px 1px rgba(0,0,0), 2px 2px rgba(0,0,0), 3px 3px rgba(0,0,0), 4px 4px rgba(0,0,0), 5px 5px 0px 0px rgba(0,0,0)',
        _dark: {
          borderColor: 'white',
          boxShadow: '1px 1px rgba(255,255,255), 2px 2px rgba(255,255,255), 3px 3px rgba(255,255,255), 4px 4px rgba(255,255,255), 5px 5px 0px 0px rgba(255,255,255)',
        },
      })}>
        Brutal
      </button>
