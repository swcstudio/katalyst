...
export const AceternityTestShowcase: Component = () => {
  ...
  const testSections: TestSection[] = [
    // Core Components
    {
      ...
      category: 'core',
      component: () => (
        <div class={css({ height: '300px', width: '100%', position: 'relative', backgroundColor: 'black', borderRadius: 'md' })}>
          <SparklesCore
            particleDensity={500}
            minSize={0.5}
            maxSize={2}
        ...
        <Stagger staggerDelay={0.2} variant="fadeInUp">
          <div class={css({ display: 'flex', gap: '4', flexWrap: 'wrap' })}>
            <Motion variant="fadeIn" duration={0.5}>
              <div class={css({ padding: '4', backgroundColor: 'blue.500', color: 'white', borderRadius: 'md' })}>
                Fade In
              </div>
            </Motion>
            <Motion variant="scaleIn" duration={0.5}>
              <div class={css({ padding: '4', backgroundColor: 'green.500', color: 'white', borderRadius: 'md' })}>
                Scale In
              </div>
            </Motion>
            <Motion variant="slideInLeft" duration={0.5}>
              <div class={css({ padding: '4', backgroundColor: 'purple.500', color: 'white', borderRadius: 'md' })}>
                Slide Left
              </div>
            </Motion>
          </div>
      ...
      component: () => (
        <div class={css({ display: 'flex', gap: '4', flexWrap: 'wrap' })}>
          <HoverMotion scale={1.1} rotate={5} lift={true}>
            <div class={css({ padding: '6', backgroundColor: 'orange.500', color: 'white', borderRadius: 'md', cursor: 'pointer' })}>
              Hover Scale + Rotate
            </div>
          </HoverMotion>
          <HoverMotion scale={1.05} lift={true}>
            <div class={css({ padding: '6', backgroundColor: 'red.500', color: 'white', borderRadius: 'md', cursor: 'pointer' })}>
              Hover Lift
            </div>
          </HoverMotion>
        </div>
                  ...
                  <div class={css({
                    ...
                    <div class={css({ display: 'flex', gap: '2' })}>
                      <span class={css({
                        ...
                        fontWeight: 'medium',
                        borderRadius: 'full',
                        backgroundColor: section.category === 'core' ? 'red.100' : 
                                      section.category === 'motion' ? 'blue.100' :
                                      section.category === 'animation' ? 'green.100' : 'purple.100',
                        color: section.category === 'core' ? 'red.800' : 
                               section.category === 'motion' ? 'blue.800' :
                               section.category === 'animation' ? 'green.800' : 'purple.800',
                      })}>
                        {section.category}
                      </span>
