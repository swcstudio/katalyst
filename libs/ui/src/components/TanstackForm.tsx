  ...
  return (
    <div class={css({ padding: '4', borderRadius: 'md', bg: 'gray.50', _dark: { bg: 'gray.800' } })}>
      ...
      <Show when={!isSubmitted()} fallback={
        <div class={css({ p: '4', bg: 'green.100', color: 'green.800', borderRadius: 'md', _dark: { bg: 'green.900', color: 'green.200' } })}>
        ...
        <form onSubmit={handleSubmit} class={flex({ direction: 'column', gap: '4' })}>
          <div>
            <label 
              for="name" 
              class={css({ display: 'block', mb: '1', fontWeight: 'medium', color: 'gray.700', _dark: { color: 'gray.300' } })}
            >
              Name
            </label>
            <input
            ...
            <Show when={errors().name}>
              <p class={css({ mt: '1', fontSize: 'sm', color: 'red.500' })}>
                {errors().name}
              </p>
            </Show>
          </div>
