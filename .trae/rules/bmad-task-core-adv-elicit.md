...
<task id=".pap/core/tasks/adv-elicit.xml" name="Advanced Elicitation" standalone="true"
  methods="{project-root}/.pap/core/tasks/adv-elicit-methods.csv"
  agent-party="{project-root}/.pap/_cfg/agent-manifest.csv">
  <llm critical="true">
...
Reference this task with `@task-adv-elicit` to execute the defined workflow.
