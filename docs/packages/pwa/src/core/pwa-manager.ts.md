...
> Source: `src/core/pwa-manager.ts`
...
- `../detection/capability-checker`
- `./manifest-generator`
- `./service-worker`
- `./install-prompt`
- `../bridge/native-bridge`
- `../offline/offline-manager`
- `../notifications/push-manager`
- `../analytics/pwa-analytics`
- `../platforms/mobile-adapter`
- `../platforms/desktop-adapter`
- `../platforms/metaverse-adapter`

## Exports

### `PWAManager`

<!-- TODO: Add detailed documentation for PWAManager -->
