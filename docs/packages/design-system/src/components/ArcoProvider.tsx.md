...
> Source: `src/components/ArcoProvider.tsx`
...
- `../../integrations/arco`
- `../design-system-store`
- `@arco-design/web-react/es/locale/de-DE`
- `@arco-design/web-react/es/locale/en-US`
- `@arco-design/web-react/es/locale/es-ES`
- `@arco-design/web-react/es/locale/fr-FR`
- `@arco-design/web-react/es/locale/it-IT`
- `@arco-design/web-react/es/locale/ja-JP`
- `@arco-design/web-react/es/locale/ko-KR`
- `@arco-design/web-react/es/locale/pt-BR`
- `@arco-design/web-react/es/locale/ru-RU`
...
<!-- TODO: Add detailed documentation for ArcoProviderProps -->

### `useArcoContext`

<!-- TODO: Add detailed documentation for useArcoContext -->

### `ArcoProvider`

<!-- TODO: Add detailed documentation for ArcoProvider -->

### `withArco`

<!-- TODO: Add detailed documentation for withArco -->
