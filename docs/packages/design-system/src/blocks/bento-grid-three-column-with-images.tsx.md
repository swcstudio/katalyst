...
> Source: `src/blocks/bento-grid-three-column-with-images.tsx`
...
<!-- TODO: Add detailed documentation for ThreeColumnsWithImages -->
  ...
  return (
    <div className="mx-auto my-20 w-full max-w-7xl px-4 md:px-8">
      ...
      <p className="mx-auto mt-4 max-w-lg text-center text-sm text-neutral-600 dark:text-neutral-400">
        Our state of the art dashboard features the most comprehensive insights for your SaaS tool,
        with a blazing fast, we are so back AI text generation model.
      </p>
