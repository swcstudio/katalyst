...
> Source: `src/blocks/pricing-section-with-switch-and-add-on.tsx`
...
<!-- TODO: Add detailed documentation for PricingWithSwitchAndAddOn -->

### `Pricing`

<!-- TODO: Add detailed documentation for Pricing -->

### `Tier`

<!-- TODO: Add detailed documentation for Tier -->

### `tiers`

<!-- TODO: Add detailed documentation for tiers -->
...
import { IconCircleCheckFilled, IconMessageCircleQuestion } from '@tabler/icons-react';
        ...
        {tiers.map((tier, tierIdx) => (
          <div
            ...
            className={cn(
              ...
              tier.featured && 'relative bg-white shadow-2xl dark:bg-neutral-900'
            )}
          >
            <div className="">
              <h3
    ...
    <section className="relative z-20 mx-auto my-20 grid w-full max-w-6xl grid-cols-1 justify-start bg-gradient-to-br from-gray-100 to-white md:my-40 md:grid-cols-3 dark:from-neutral-900 dark:to-neutral-950">
      ...
      <div className="p-8 md:col-span-2 md:p-14">
        <h2 className="text-left text-xl font-medium tracking-tight text-neutral-500 md:text-3xl dark:text-neutral-200">
          ...
          <span className="font-bold text-black dark:text-white">10 people </span>
          and get
      ...
      <div className="border-t border-dashed p-8 md:border-l md:border-t-0 md:p-14">
        <p className="text-base text-neutral-700 dark:text-neutral-200">
          &quot;This is the best product ever when it comes to shipping. Ten on ten recommended. I
          just can&apos;t wait to see what happens with this product.&quot;
        </p>
        <div className="mt-4 flex flex-col items-start gap-1 text-sm">
          ...
          <p className="text-neutral-500 dark:text-neutral-400">Side projects builder</p>
        </div>
      </div>
    </section>
  );
...
export const Icon = ({ className, ...rest }: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      ...
      strokeWidth="1"
      stroke="currentColor"
      className={cn('h-4 w-4 text-neutral-400 md:h-8 md:w-8 dark:text-neutral-600', className)}
      {...rest}
    >
