...
> Source: `src/blocks/hero-section-with-beams-and-grid.tsx`
...
<!-- TODO: Add detailed documentation for HeroSectionWithBeamsAndGrid -->
  ...
  return (
    ...
    >
      ...
      <p className="relative z-50 mx-auto mt-4 max-w-lg px-4 text-center text-base/6 text-gray-600 dark:text-gray-200">
        Get the best beam tracking services in the world with our state of the art, cutting edge
