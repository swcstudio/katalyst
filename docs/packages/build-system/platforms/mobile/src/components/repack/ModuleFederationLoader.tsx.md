...
> Source: `platforms/mobile/src/components/repack/ModuleFederationLoader.tsx`
...
<!-- TODO: Add detailed documentation for ModuleFederationLoaderProps -->

### `ModuleFederationLoader`

<!-- TODO: Add detailed documentation for ModuleFederationLoader -->

### `createFederatedComponent`

<!-- TODO: Add detailed documentation for createFederatedComponent -->

### `BatchLoaderProps`

<!-- TODO: Add detailed documentation for BatchLoaderProps -->

### `FederatedModuleBatchLoader`

<!-- TODO: Add detailed documentation for FederatedModuleBatchLoader -->

### `useFederatedModule`

<!-- TODO: Add detailed documentation for useFederatedModule -->
