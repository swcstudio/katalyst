...
> Source: `platforms/metaverse/src/core/XRCanvas.tsx`
...
- `../optimization/PerformanceMonitor`
- `../stores/xr-store`
- `./SpatialAudio`
...
<!-- TODO: Add detailed documentation for XRCanvasProps -->

### `XRCanvas`

<!-- TODO: Add detailed documentation for XRCanvas -->
