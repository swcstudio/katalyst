...
**Package:** `@katalyst/multithreading`

## Overview

This module is part of the `@katalyst/multithreading` package.
...
<!-- TODO: Add detailed documentation for ThreadControllerOptions -->

### `ThreadPoolConfig`

<!-- TODO: Add detailed documentation for ThreadPoolConfig -->

### `ChannelConfig`

<!-- TODO: Add detailed documentation for ChannelConfig -->

### `RuntimeConfig`

<!-- TODO: Add detailed documentation for RuntimeConfig -->

### `BenchmarkOptions`

<!-- TODO: Add detailed documentation for BenchmarkOptions -->

### `StressTestOptions`

<!-- TODO: Add detailed documentation for StressTestOptions -->

### `ThreadPoolController`

<!-- TODO: Add detailed documentation for ThreadPoolController -->

### `ChannelController`

<!-- TODO: Add detailed documentation for ChannelController -->

### `AtomicCellController`

<!-- TODO: Add detailed documentation for AtomicCellController -->

### `RuntimeController`

<!-- TODO: Add detailed documentation for RuntimeController -->

### `SystemStatus`

<!-- TODO: Add detailed documentation for SystemStatus -->
...
*Generated documentation for @katalyst/multithreading*
