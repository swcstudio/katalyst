...
> Source: `src/plugins/rspack-config-builder.ts`
...
### `RSpackConfigBuilderOptions`

<!-- TODO: Add detailed documentation for RSpackConfigBuilderOptions -->

### `RSpackConfigBuilder`

<!-- TODO: Add detailed documentation for RSpackConfigBuilder -->

### `RSpackPresets`

<!-- TODO: Add detailed documentation for RSpackPresets -->
