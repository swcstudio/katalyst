...
> Source: `src/plugins/zephyr-rspack-plugin.ts`
...
<!-- TODO: Add detailed documentation for ZephyrRSpackPluginOptions -->

### `ZephyrRSpackPlugin`

<!-- TODO: Add detailed documentation for ZephyrRSpackPlugin -->

### `createZephyrRSpackPlugin`

<!-- TODO: Add detailed documentation for createZephyrRSpackPlugin -->

### `ZephyrRSpackPresets`

<!-- TODO: Add detailed documentation for ZephyrRSpackPresets -->
