...
> Source: `src/dev-tools/fast-refresh/index.ts`
...
### `createWebFastRefreshConfig`

<!-- TODO: Add detailed documentation for createWebFastRefreshConfig -->

### `createMobileFastRefreshConfig`

<!-- TODO: Add detailed documentation for createMobileFastRefreshConfig -->

### `createKatalystFastRefreshConfig`

<!-- TODO: Add detailed documentation for createKatalystFastRefreshConfig -->

### `detectBundler`

<!-- TODO: Add detailed documentation for detectBundler -->

### `detectPlatform`

<!-- TODO: Add detailed documentation for detectPlatform -->

### `createAutoDetectedConfig`

<!-- TODO: Add detailed documentation for createAutoDetectedConfig -->

### `FastRefreshDevtools`

<!-- TODO: Add detailed documentation for FastRefreshDevtools -->

### `setupKatalystFastRefresh`

<!-- TODO: Add detailed documentation for setupKatalystFastRefresh -->

### `FastRefreshPerformanceMonitor`

<!-- TODO: Add detailed documentation for FastRefreshPerformanceMonitor -->

### `FastRefreshErrorBoundary`

<!-- TODO: Add detailed documentation for FastRefreshErrorBoundary -->
