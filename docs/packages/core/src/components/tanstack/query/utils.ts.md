...
> Source: `src/components/tanstack/query/utils.ts`
...
<!-- TODO: Add detailed documentation for isDataStale -->

### `getQueryKeysByPattern`

<!-- TODO: Add detailed documentation for getQueryKeysByPattern -->

### `updateInfiniteQueryData`

<!-- TODO: Add detailed documentation for updateInfiniteQueryData -->

### `mergeInfiniteData`

<!-- TODO: Add detailed documentation for mergeInfiniteData -->

### `handleQueryError`

<!-- TODO: Add detailed documentation for handleQueryError -->

### `createQueryKeyFactory`

<!-- TODO: Add detailed documentation for createQueryKeyFactory -->

### `createQueryPersister`

<!-- TODO: Add detailed documentation for createQueryPersister -->

### `dedupeInFlightRequests`

<!-- TODO: Add detailed documentation for dedupeInFlightRequests -->
