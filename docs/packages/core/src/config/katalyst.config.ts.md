...
> Source: `src/config/katalyst.config.ts`
...
### `defaultKatalystConfig`

<!-- TODO: Add detailed documentation for defaultKatalystConfig -->

### `createKatalystConfig`

<!-- TODO: Add detailed documentation for createKatalystConfig -->
