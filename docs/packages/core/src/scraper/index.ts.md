...
- `./core/engine.ts`
- `./engines/cheerio-engine.ts`
- `./engines/playwright-engine.ts`
- `@katalyst/scraper`
- `@katalyst/scraper`
- `@katalyst/scraper`
...
<!-- TODO: Add detailed documentation for createScraper -->

### `ExtractionRules`

<!-- TODO: Add detailed documentation for ExtractionRules -->
