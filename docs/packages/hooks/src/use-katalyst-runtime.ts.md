...
> Source: `src/use-katalyst-runtime.ts`
...
- `react`
- `../components/UnifiedRuntimeProvider.tsx`
- `./use-multithreading.ts`

## Exports

### `KatalystRuntimeConfig`

<!-- TODO: Add detailed documentation for KatalystRuntimeConfig -->

### `useKatalystRuntime`

<!-- TODO: Add detailed documentation for useKatalystRuntime -->
