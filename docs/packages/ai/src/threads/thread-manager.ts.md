...
> Source: `src/threads/thread-manager.ts`

**Package:** `@katalyst/ai`

## Overview

This module is part of the `@katalyst/ai` package.
...
<!-- TODO: Add detailed documentation for ThreadConfig -->

### `ThreadMessage`

<!-- TODO: Add detailed documentation for ThreadMessage -->

### `ThreadStatus`

<!-- TODO: Add detailed documentation for ThreadStatus -->

### `ThreadSnapshot`

<!-- TODO: Add detailed documentation for ThreadSnapshot -->
...
*Generated documentation for @katalyst/ai*
