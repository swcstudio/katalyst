...
> Source: `src/auth/claude-auth.ts`
...
<!-- TODO: Add detailed documentation for ClaudeAuthConfig -->

### `ClaudeAuthToken`

<!-- TODO: Add detailed documentation for ClaudeAuthToken -->

### `ClaudeCodeAuth`

<!-- TODO: Add detailed documentation for ClaudeCodeAuth -->
