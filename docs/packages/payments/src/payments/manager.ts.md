...
> Source: `src/payments/manager.ts`
...
- `./providers/hyperswitch.ts`
- `./providers/oneinch.ts`
- `./providers/symbiosis.ts`
- `./providers/walletconnect.ts`
- `./config.ts`
...
<!-- TODO: Add detailed documentation for PaymentManager -->
